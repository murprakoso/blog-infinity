...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        @include('layouts._dashboard._sidebar')
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                @include('layouts._dashboard._navbar')
                <!-- End of Topbar -->
            ...
            <!-- Footer -->
            @include('layouts._dashboard._footer')
            <!-- End of Footer -->
    ...
    {{-- <script src="{{ asset('vendor/dashboard/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('vendor/dashboard/js/demo/chart-pie-demo.js') }}"></script> --}}
