                    ...
                    <form action="{{ route('categories.update', ['category' => $category]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_category_slug" value="{{ old('slug', $category->slug) }}" name="slug"
                                type="text" class="form-control @error('slug') is-invalid @enderror" readonly
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="input_category_thumbnail" name="thumbnail"
                                    ...
                                    class="form-control @error('thumbnail') is-invalid @enderror" readonly
                        ...
                        <div class="float-right">
                            <a href="{{ route('categories.index') }}" class="btn btn-light btn-icon-split shadow border"
                                role="button">
