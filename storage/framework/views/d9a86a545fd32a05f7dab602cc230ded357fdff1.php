<?php $__env->startSection('title', trans('tags.title.create')); ?>

<?php $__env->startSection('breadcrumbs', Breadcrumbs::render('add_tag')); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('tags.store')); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_tag_title" value="<?php echo e(old('title')); ?>" name="title" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_tag_slug" value="<?php echo e(old('slug')); ?>" name="slug" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="float-right">
                            ...
                            <button type="submit" class="btn btn-primary btn-icon-split shadow border">
                                ...
                                <span class="text">
                                    <?php echo e(trans('tags.button.save.value')); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROGRAMMING\FunCode\infinity15\resources\views/tags/create.blade.php ENDPATH**/ ?>