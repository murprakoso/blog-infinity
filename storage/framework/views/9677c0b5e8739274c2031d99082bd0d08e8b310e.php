<?php $__env->startSection('title', trans('roles.title.create')); ?>

<?php $__env->startSection('breadcrumbs', Breadcrumbs::render('add_role')); ?>
                ...
                <form action="<?php echo e(route('roles.store')); ?>" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="input_role_name" value="<?php echo e(old('name')); ?>" name="name" type="text"
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <?php if(old('permissions')): ?>
                                                            <input id="<?php echo e($permission); ?>" name="permissions[]"
                                                                ...
                                                                <?php echo e(in_array($permission, old('permissions')) ? 'checked' : null); ?>>
                                                        <?php else: ?>
                                                            <input id="<?php echo e($permission); ?>" name="permissions[]"
                                                                class="form-check-input" type="checkbox"
                                                                value="<?php echo e($permission); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="float-right mb-4">
                            ...
                            <button type="submit" class="btn btn-primary btn-icon-split shadow border">
                                ...
                                <span class="text">
                                    <?php echo e(trans('roles.button.save.value')); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROGRAMMING\FunCode\infinity15\resources\views/roles/create.blade.php ENDPATH**/ ?>