<?php $__env->startSection('title', trans('categories.title.create')); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('categories.store')); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_category_title" value="<?php echo e(old('title')); ?>" name="title" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_category_slug" value="<?php echo e(old('slug')); ?>" name="slug" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="input_category_thumbnail" name="thumbnail" value="<?php echo e(old('thumbnail')); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select id="select_category_parent" name="parent_category"
                                ...
                                <?php if(old('parent_category')): ?>
                                    <option value="<?php echo e(old('parent_category')->id); ?>" selected>
                                        <?php echo e(old('parent_category')->title); ?>
...
unset($__errorArgs, $__bag); ?>" rows="3"
                                placeholder="<?php echo e(trans('categories.form_control.textarea.description.placeholder')); ?>"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROGRAMMING\FunCode\infinity15\resources\views/categories/create.blade.php ENDPATH**/ ?>