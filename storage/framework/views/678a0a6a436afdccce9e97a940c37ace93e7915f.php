<?php $__env->startSection('title', trans('posts.title.create')); ?>

<?php $__env->startSection('breadcrumbs', Breadcrumbs::render('add_post')); ?>
                        ...
                        <div class="row d-flex align-items-stretch">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input_post_title" value="<?php echo e(old('title')); ?>" name="title" type="text"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input_post_slug" value="<?php echo e(old('slug')); ?>" name="slug" type="text"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="input_post_thumbnail" name="thumbnail" value="<?php echo e(old('thumbnail')); ?>"
                                            type="text" class="form-control <?php $__errorArgs = ['thumbnail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        rows="20"><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        style="height: 886px">
                                        <!-- List category -->
                                        <?php echo $__env->make('posts._category-list',['categories' =>
                                        $categories, 'categoryChecked' => old('category')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <!-- List category -->
                                    </div>
...
unset($__errorArgs, $__bag); ?>" multiple>
                                        ...
                                        <?php if(old('tag')): ?>
                                            <?php $__currentLoopData = old('tag'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>"
                                                <?php echo e(old('status') == $key ? 'selected' : null); ?>><?php echo e($value); ?>
                            ...
                            <div class="col-md-12">
                                <div class="float-right">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-icon-split shadow border">
                                        ...
                                        <span class="text">
                                            <?php echo e(trans('posts.button.save.value')); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROGRAMMING\FunCode\infinity15\resources\views/posts/create.blade.php ENDPATH**/ ?>