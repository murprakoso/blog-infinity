...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('categories.index', ['categories' => $categories->paginate(5)->appends(['keyword' => $request->get('keyword')])]);
    }
    ...
    public function destroy(Category $category)
    {
        try {
            ...
            // );
            toast(trans('categories.alert.delete.message.error'), 'error');
        }
