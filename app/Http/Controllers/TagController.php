...
class TagController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tags.index', ['tags' => $tags->appends(['keyword' => $request->keyword])]);
    }
    ...
    public function update(Request $request, Tag $tag)
    {
        ...
        try {
            ...
            Alert::success(trans('tags.alert.update.title'), trans('tags.alert.update.message.success'));
            return redirect()->route('tags.index');
        } catch (\Throwable $th) {
            Alert::error(trans('tags.alert.update.title'), trans('tags.alert.update.message.error', ['error' => $th->getMessage()]));
            return redirect()->back()->withInput($request->all());
        }
    }
    ...
    public function destroy(Tag $tag)
    {
        try {
            ...
            // toast(trans('tags.alert.delete.message.error'), 'error');
        }
        return redirect()->back();
    }

    /**
     * multibahasa untuk validasi atribut
     */
